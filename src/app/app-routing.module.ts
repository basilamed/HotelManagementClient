...
const routes: Routes = [
  ...
  { path: 'all-reservations', component: AllReservationsComponent, canActivate: [RoleGuard], data: {allowedRole: 1}},
  { path: 'receipts', component: ReceiptsComponent, canActivate: [RoleGuard], data: {allowedRole: 4}}
];
